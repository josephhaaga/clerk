...
from src.clerk.app import main
from src.clerk.app import Application
...
@patch("src.clerk.app.Application.open_file")
def test_main_loop(patched_open_file, phrase, date):
    ...
    with patch("src.clerk.app.get_config", lambda: EXAMPLE_CONFIG):
